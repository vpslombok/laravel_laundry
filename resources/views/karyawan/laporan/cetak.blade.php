...
<body>
    <div class="container-fluid">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        ...
                        <p style="text-align:right"><b>Tanggal Masuk :</b> <i class="fa fa-calendar"></i> {{carbon\carbon::parse($data->tgl_transaksi)->format('d-m-Y H:i:s')}}</p>
                        <p style="text-align:right"><b>Tanggal Diambil :</b> <i class="fa fa-calendar"></i>
                            @if ($data->tgl_ambil == "")
                            Belum Diambil
                            @else
                            {{carbon\carbon::parse($data->tgl_ambil)->format('d-m-Y H:i:s')}}
                            @endif
                        </p>
                    </td>
                </tr>
        ...
        <h6 style="font-weight:bold">Metode Pembayaran :</h6>
                    <div>
                        <li style="color: black"> {{$data->jenis_pembayaran}}</li>
                    </div>
    </div>
</body>
