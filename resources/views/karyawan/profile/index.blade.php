                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group has-success">
                        ...
                        <input type="text" name="email" value=" {{Auth::user()->email}} " class="form-control @error('email') is-invalid @enderror" readonly>
                        @error('email')
                          <span class="invalid-feedback text-danger" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                    ...
                    <div class="col-md-12">
                      <div class="form-group has-success">
                        ...
                        <textarea name="alamat" class="form-control" id="alamat" cols="5" readonly> {{Auth::user()->alamat}} </textarea>
                        @error('alamat')
                          <span class="invalid-feedback text-danger" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                    ...
                    <div class="col-md-6">
                      <div class="form-group has-success">
                        ...
                        <input type="text" name="number" class="form-control" value="{{Auth::user()->no_telp}}" readonly />
                        @error('no_telp')
                          <span class="invalid-feedback text-danger" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                    ...
                    <div class="col-md-6">
                      <div class="form-group has-success">
                        ...
                        <input type="file" name="foto" class="form-control @error('foto') is-invalid @enderror" readonly>
                    ...
                    <div class="col-md-6">
                      <div class="form-group has-success">
                        ...
                        <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" readonly>
                        <span class="small text-warning">Biarkan kosong jika tidak ingin di update.</span>
                        @error('password')
                          <span class="invalid-feedback text-danger" role="alert">
                              <strong>{{ $message }}</strong>
                    ...
                    <div class="col-md-6">
                      <div class="form-group has-success">
                        ...
                        <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" readonly>
                        <span class="small text-warning">Biarkan kosong jika tidak ingin di update.</span>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                      <div class="form-group has-success">
                        ...
                        <input type="text" name="nama_cabang" class="form-control" value="{{Auth::user()->nama_cabang}}" readonly />
                        @error('nama_cabang')
                          <span class="invalid-feedback text-danger" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
                    ...
                    <div class="col-md-12">
                      <div class="form-group has-success">
                        ...
                        <textarea name="alamat_cabang" class="form-control" id="alamat_cabang" cols="5" readonly> {{Auth::user()->alamat_cabang}} </textarea>
                        @error('alamat_cabang')
                          <span class="invalid-feedback text-danger" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
