            ...
            <div class="card-header">
                ...
                <div class="d-flex align-items-center">
                    <p class="card-text font-small-2 mr-25 mb-0">
                        Diperbarui {{ \Carbon\Carbon::parse($lastUpdated)->diffForHumans() }}
                    </p>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <p class="card-text text-muted font-small-2">
                                    <span> Pendapatan {{$incomeM >= $incomeMOld ? 'naik' : 'turun'}} </span> <span class="font-weight-bolder">{{round($persen)}}%</span> <span> dari bulan kemarin.</span>
                                </p>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    var salesavgChartoptions = {
        ...
        series: [{
            name: "Total Laundry",
            data: <?php echo json_encode($_nilaiB); ?>,
        }],
