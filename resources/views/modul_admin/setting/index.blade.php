                ...
                <div class="tab-pane fade" id="vertical-notif" role="tabpanel" aria-labelledby="pill-notif" aria-expanded="false">
                  ...
                  <form action="{{route('set-notif.update', Auth::id())}}" method="post">
                    ...
                    <div class="row">
                      ...
                      <h5 class="m-1">WhatsApp Notifikasi</h5>
                      <div class="col-12 mb-1">
                        <div class="custom-control custom-switch custom-control-inline">
                          ...
                          <span class="switch-label w-100">Aktifkan Jika Ingin Mengirimkan Notifikasi Setiap Order Kepada Customer</span>
                        </div>
                      </div>

                      <h5 class="m-1">API URL</h5>
                      <div class="col-md-12 mb-1">
                        <div class="form-group">
                          <input type="text" name="wa_api_url" class="form-control" placeholder="Masukan API URL" value="{{$setnotif->wa_api_url}}">
                          @if ($setnotif->wa_order_selesai == 1)
                          @if ($setnotif->wa_api_url == '')
                          <small class="text-danger">API URL wajib diisi.</small>
                          @endif
                          @endif
                        </div>
                      </div>
