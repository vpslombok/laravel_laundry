            ...
            <div class="card knowledge-base-bg text-center" style="background-image: url('{{asset(`backend/images/pages/banner.png`)}}');">
                <div class="card-body">
                    ...
                    <p class="card-text mb-2">
                        <span>Halo, halaman ini digunakan untuk keperluan dokumentasi penggunaan pada aplikasi Laundry. Dokumentasi ini dibuat untuk mempermudah teman-teman dalam penggunaan aplikasi Laundry.</span>
                    </p>
                </div>
            </div>
        </div>
